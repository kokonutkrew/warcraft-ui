					...
					["objects"] = {
						{
							...
							["d"] = {
								...
								1, -- [3]
								true, -- [4]
								"Walk past here like normal, then use a ranged ability to pull the miniboss. It won't social aggro the other mobs. Fight it outside.", -- [5]
							},
						}, -- [1]
						{
							["n"] = true,
							["d"] = {
								...
								1, -- [3]
								true, -- [4]
								"This is an ideal pack to kill with the Venthyr lantern open outside.", -- [5]
							},
						}, -- [2]
						{
							["n"] = true,
							["d"] = {
								...
								1, -- [3]
								true, -- [4]
								"Pull this back to avoid accidentally getting the miniboss before you're ready.", -- [5]
							},
						}, -- [3]
						{
							["d"] = {
					...
					["objects"] = {
						...
						}, -- [3]
						{
							...
							["d"] = {
								...
								3, -- [3]
								true, -- [4]
								"hug the outside right of the stairs, to skip G26.", -- [5]
							},
						}, -- [4]
						{
							["d"] = {
								...
								3, -- [3]
								true, -- [4]
								"Line of sight pull G32 behind this pillar", -- [5]
							},
							["n"] = true,
						}, -- [5]
						{
						...
						}, -- [7]
						{
							...
							["d"] = {
								...
								3, -- [3]
								true, -- [4]
								"Skip G27, by CCing Warden and jump up the ledge to the right. Make sure no one is in combat after this.", -- [5]
							},
						}, -- [8]
						{
							["l"] = {
						...
						}, -- [13]
						{
							...
							["d"] = {
								...
								2, -- [3]
								true, -- [4]
								"Kyrian spear here, pick it up.", -- [5]
							},
						}, -- [14]
						{
							["n"] = true,
						...
						}, -- [15]
						{
							...
							["d"] = {
								...
								4, -- [3]
								true, -- [4]
								"if Fortified week, use Lust+2nd Spear on this 3rd angel. I would prefer clearing Astronos -> Lakesis -> Klotos", -- [5]
							},
						}, -- [16]
						{
							["d"] = {
								...
								1, -- [3]
								true, -- [4]
								"you can do a triple pull if u want G1+2+Goliath", -- [5]
							},
							["n"] = true,
						}, -- [17]
					},
