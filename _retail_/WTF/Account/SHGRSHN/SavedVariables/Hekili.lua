...
HekiliDB = {
	...
	["profileKeys"] = {
		...
		["Threadcrafts - Emerald Dream"] = "Default",
				...
				["Windwalker"] = {
					...
					["lists"] = {
						...
						["serenity"] = {
							...
							{
								["interrupt_if"] = "buff.serenity.remains>1",
								["action"] = "fists_of_fury",
								["enabled"] = true,
							}, -- [4]
							{
				...
				["Shadow"] = {
					...
					["lists"] = {
						["filler"] = {
							{
								["enabled"] = true,
								["criteria"] = "buff.mind_flay_insanity.up & dot.vampiric_touch.ticking & dot.shadow_word_pain.ticking & ( ! buff.surge_of_darkness.up || talent.screams_of_the_void.enabled )",
								["action"] = "mind_flay",
							}, -- [1]
							{
								["enabled"] = true,
							...
							{
								["enabled"] = true,
								["criteria"] = "buff.surge_of_darkness.up",
								["action"] = "mind_spike",
							}, -- [3]
							{
								["enabled"] = true,
								["criteria"] = "! raid_event.adds.exists || raid_event.adds.in > 75 || spell_targets.lights_judgment > 1",
								["action"] = "lights_judgment",
							}, -- [4]
							{
								["enabled"] = true,
							...
							{
								["enabled"] = true,
								["criteria"] = "target.health.pct < 20 & ( spell_targets.mind_sear < 4 || talent.inescapable_torment.rank = 2 & pet.fiend.active )",
							...
							{
								["enabled"] = true,
								["criteria"] = "( ! talent.mental_decay.enabled || dot.vampiric_touch.remains >= ( cooldown.shadow_crash.remains + action.shadow_crash.travel_time ) ) & ! talent.idol_of_cthun.enabled",
								["action"] = "mind_spike",
							}, -- [8]
							{
								["enabled"] = true,
						...
						["main_variables"] = {
							...
							}, -- [2]
							{
								...
								["op"] = "set",
								["action"] = "variable",
								["value"] = "( cooldown.void_eruption.remains <= gcd.max * 3 & talent.void_eruption.enabled || cooldown.dark_ascension.up & talent.dark_ascension.enabled ) || talent.void_torrent.enabled & talent.psychic_link.enabled & cooldown.void_torrent.remains <= 4 & ( ! raid_event.adds.",
						...
						["aoe_variables"] = {
							...
							}, -- [3]
							{
								...
								["op"] = "set",
								["action"] = "variable",
								["value"] = "( active_dot.vampiric_touch + 8 * action.shadow_crash.in_flight ) >= variable.max_vts || ! variable.is_vt_possible",
						...
						["trinkets"] = {
							...
							}, -- [5]
							{
								...
								["criteria"] = "boss & fight_remains < 20 || ! talent.ancient_madness.enabled || ( cooldown.dark_ascension.remains > 10 & talent.dark_ascension.enabled ) || ( cooldown.void_eruption.remains > 10 & talent.void_eruption.enabled ) || ( ! talent.void_eruption.enabled & ! talent.dark_ascension.enabled )",
								["description"] = "Sync with cooldowns for Ancient Madness or use when the fight will end soon or at full stacks",
							}, -- [6]
						},
						["main"] = {
							{
							...
							{
								["enabled"] = true,
								["criteria"] = "( variable.dots_up || action.shadow_crash.in_flight ) & ( boss & fight_remains < 30 || time_to_die > 15 )",
								["action"] = "mindbender",
							}, -- [2]
							{
								["enabled"] = true,
								["criteria"] = "( cooldown.mind_blast.full_recharge_time <= gcd.max + cast_time || pet.fiend.remains <= cast_time + gcd.max ) & pet.fiend.active & talent.inescapable_torment.enabled & pet.fiend.remains > cast_time & spell_targets.mind_sear <= 7",
								["action"] = "mind_blast",
								["description"] = "High priority Mind Blast action when using Inescapable Torment",
							}, -- [3]
							{
								["enabled"] = true,
								["criteria"] = "dot.vampiric_touch.refreshable || dot.shadow_word_pain.refreshable",
								["action"] = "damnation",
								["cycle_targets"] = 1,
							}, -- [4]
							{
							...
							}, -- [5]
							{
								...
								["action"] = "mind_sear",
								["cycle_targets"] = 1,
								["description"] = "Use Mind Devourer Procs on Mind Sear when facing 2 or more targets",
								["criteria"] = "spell_targets.mind_sear > 1 & buff.mind_devourer.up",
							}, -- [6]
							{
								["enabled"] = true,
								["criteria"] = "( refreshable & ! variable.pool_for_cds || insanity > 75 || talent.void_torrent.enabled & cooldown.void_torrent.remains <= 3 * gcd.max ) & variable.dp_cutoff",
								["action"] = "devouring_plague",
							}, -- [7]
							{
								["enabled"] = true,
								["criteria"] = "refreshable & target.time_to_die >= 12 & ( cooldown.shadow_crash.remains >= dot.vampiric_touch.remains & ! action.shadow_crash.in_flight || variable.holding_crash )",
								["action"] = "vampiric_touch",
								["cycle_targets"] = 1,
							}, -- [8]
							{
							...
							{
								["enabled"] = true,
								["criteria"] = "buff.mind_flay_insanity.up & variable.dots_up & ( talent.inescapable_torment.rank < 2 || ! pet.fiend.active ) & cooldown.mind_blast.full_recharge_time >= gcd.max * 3 & talent.idol_of_cthun.enabled",
								["action"] = "mind_flay",
							}, -- [10]
							{
								["enabled"] = true,
								["criteria"] = "( target.health.pct < 20 & spell_targets.mind_sear < 4 ) & ( talent.inescapable_torment.rank < 2 || cooldown.fiend.remains >= 10 ) || ( pet.fiend.active & talent.inescapable_torment.rank > 1 & spell_targets.mind_sear <= 7 ) || buff.deathspeaker.up",
								["action"] = "shadow_word_death",
							}, -- [11]
							{
								["enabled"] = true,
							...
							}, -- [12]
							{
								...
								["action"] = "mindgames",
								["description"] = "TODO: Dont use if add events are coming soon when talented into PL",
							}, -- [13]
							{
								["enabled"] = true,
								["criteria"] = "raid_event.adds.in > 10",
						...
						["aoe"] = {
							...
							{
								["enabled"] = true,
								["criteria"] = "( dot.shadow_word_pain.ticking & variable.vts_applied || action.shadow_crash.in_flight ) & ( fight_remains < 30 || time_to_die > 15 )",
								["action"] = "mindbender",
							}, -- [4]
							{
								["enabled"] = true,
								["criteria"] = "cooldown.mind_blast.full_recharge_time <= gcd.max + cast_time & talent.mind_devourer.rank = 2 & spell_targets.mind_sear >= 3 & ! buff.mind_devourer.up & spell_targets.mind_sear <= 7",
								["action"] = "mind_blast",
								["description"] = "actions.aoe+=/run_action_list,name=aoe_pl_ire,if=talent.psychic_link.rank=2&talent.insidious_ire.rank=2  Use Mind Blast when capped on charges and talented into Mind Devourer to fish for the buff. Only use when facing 3-7 targets.",
							}, -- [5]
							{
								["enabled"] = true,
								["criteria"] = "( cooldown.mind_blast.full_recharge_time <= gcd.max + cast_time || pet.fiend.remains <= cast_time + gcd.max ) & pet.fiend.active & talent.inescapable_torment.enabled & pet.fiend.remains > cast_time & spell_targets.mind_sear <= 7 & ! buff.mind_devourer.up",
								["action"] = "mind_blast",
							}, -- [6]
							{
								["enabled"] = true,
								["criteria"] = "insanity <= 85",
								["action"] = "void_bolt",
							}, -- [7]
							{
								["enabled"] = true,
								["action"] = "mind_sear",
								["criteria"] = "buff.mind_devourer.up & spell_targets.mind_sear > 1 || spell_targets.mind_sear > variable.mind_sear_cutoff & ( insanity >= 75 || ( ( ! set_bonus.tier29_4pc & ! set_bonus.tier29_2pc ) || ! buff.dark_reveries.up ) || ( ! set_bonus.tier29_2pc || buff.gathering_shadows.stack = 3 ) ) & ! variable.pool_for_cds",
								["cycle_targets"] = 1,
								["interrupt_if"] = "ticks>=2&!buff.mind_devourer_ms_active.up",
								["early_chain_if"] = "ticks>=2&!buff.mind_devourer_ms_active.up",
								["interrupt_immediate"] = "1",
								["description"] = "Use Mind Sear on 3+ targets and either you have at least 75 insanity, 4pc buff is inactive, or 2pc buff is at 3 stacks, or mind devourer is up on 2+ targets. If Mind Devourer is up do not cancel mind sear.",
							}, -- [8]
							{
								["enabled"] = true,
								["action"] = "call_action_list",
								["criteria"] = "ptr = 1 & talent.void_torrent.enabled & talent.psychic_link.enabled & cooldown.void_torrent.remains <= 3 & ( ! variable.holding_crash || raid_event.adds.count / ( active_dot.vampiric_touch + raid_event.adds.count ) < 1.5 ) & ( ( insanity >= 50 || dot.devouring_plague.ticking ) & ! buff.mind_devourer.up || buff.voidform.up )",
								["list_name"] = "pl_torrent",
							}, -- [9]
							{
								["enabled"] = true,
								["criteria"] = "( refreshable & ! variable.pool_for_cds || insanity > 75 & ( ! buff.mind_flay_insanity.up & talent.mind_flay_insanity.enabled || ! talent.psychic_link.enabled ) ) & variable.dp_cutoff",
								["action"] = "devouring_plague",
							}, -- [10]
							{
								["enabled"] = true,
								["criteria"] = "refreshable & target.time_to_die >= 18 & ( dot.vampiric_touch.ticking || ! variable.vts_applied ) & variable.max_vts > 0 & ( cooldown.shadow_crash.remains >= dot.vampiric_touch.remains & ! action.shadow_crash.in_flight || variable.holding_crash )",
								["action"] = "vampiric_touch",
								["cycle_targets"] = 1,
							}, -- [11]
							{
							...
							}, -- [12]
							{
								...
								["action"] = "shadow_word_death",
								["cycle_targets"] = 1,
								["description"] = "TODO: Check Yshaarj Gains for pressing this during Inescapable Torment.",
								["criteria"] = "target.time_to_die <= 5 & insanity <= 80 & talent.death_and_madness.enabled",
							}, -- [13]
							{
								["enabled"] = true,
							...
							{
								["enabled"] = true,
								["criteria"] = "spell_targets.mind_sear < 5 & dot.devouring_plague.ticking || talent.psychic_link.enabled",
								["action"] = "mindgames",
							}, -- [16]
							{
								["enabled"] = true,
								["action"] = "void_torrent",
								["criteria"] = "insanity <= 35 & ! talent.psychic_link.enabled",
							...
							}, -- [17]
							{
								...
								["interrupt_if"] = "ticks>=2",
								["interrupt_immediate"] = "1",
								["criteria"] = "buff.mind_flay_insanity.up & buff.surge_of_darkness.remains >= 5",
							}, -- [18]
							{
								["enabled"] = true,
								["action"] = "call_action_list",
						...
						["cds"] = {
							...
							{
								["enabled"] = true,
								["criteria"] = "! cooldown.fiend.up & ( pet.fiend.active || ! talent.mindbender.enabled || spell_targets.mind_sear > 2 & talent.inescapable_torment.rank < 2 ) & ( cooldown.mind_blast.charges = 0 || time > 15 || buff.shadowy_insight.up & cooldown.mind_blast.charges = buff.shadowy_insight.stack )",
							...
							{
								["enabled"] = true,
								["criteria"] = "pet.fiend.active || ! talent.mindbender.enabled & ! cooldown.fiend.up || spell_targets.mind_sear > 2 & talent.inescapable_torment.rank < 2",
						...
						["default"] = {
							...
							}, -- [2]
							{
								...
								["op"] = "set",
								["action"] = "variable",
								["value"] = "raid_event.adds.in < 20",
								["var_name"] = "holding_crash",
							}, -- [3]
							{
								["enabled"] = true,
								["action"] = "call_action_list",
								["criteria"] = "boss & fight_remains < 30 || time_to_die > 15",
								["list_name"] = "cds",
							}, -- [4]
							{
								["enabled"] = true,
								...
								["strict"] = 1,
								["criteria"] = "spell_targets.mind_sear > 2 || spell_targets.vampiric_touch > 3",
								["list_name"] = "aoe",
							}, -- [5]
							{
								["enabled"] = true,
						...
						["pl_torrent"] = {
							...
							{
								["enabled"] = true,
								["criteria"] = "remains <= 4 & cooldown.void_torrent.remains < gcd.max & ! buff.voidform.up",
								["action"] = "devouring_plague",
							}, -- [3]
							{
								["enabled"] = true,
								["criteria"] = "buff.voidform.up & insanity >= 50",
								["action"] = "mind_sear",
							}, -- [4]
							{
								["enabled"] = true,
				...
				["Unholy"] = {
					...
					["lists"] = {
						["default"] = {
							...
							{
								["enabled"] = true,
								["criteria"] = "( ! buff.commander_of_the_dead_window.up || buff.commander_of_the_dead_window.up & cooldown.apocalypse.remains > 5 ) & runic_power.deficit > 40 & incoming_magic_3s > 0 & ( pet.gargoyle.active || ! talent.summon_gargoyle.enabled || cooldown.summon_gargoyle.remains > cooldown.antimagic_shell.duration )",
							...
							}, -- [3]
							{
								...
								["op"] = "setif",
								["action"] = "variable",
								["value"] = "active_enemies >= 3 || cooldown.summon_gargoyle.remains > 1 & cooldown.apocalypse.remains > 1 || ! talent.apocalypse.enabled & cooldown.summon_gargoyle.remains > 1 || ! talent.summon_gargoyle.enabled",
								["var_name"] = "garg_setup",
							}, -- [4]
							{
								["enabled"] = true,
							...
							{
								["enabled"] = true,
								["criteria"] = "( active_enemies <= 3 || ! talent.epidemic.enabled ) & ( pet.gargoyle.active & buff.commander_of_the_dead_window.up & buff.commander_of_the_dead_window.remains > gcd.max * 1.1 & cooldown.apocalypse.remains < gcd.max || ( ! buff.commander_of_the_dead_window.up || buff.commander_of_the_dead_window.up & cooldown.apocalypse.remains > 5 ) & debuff.death_rot.up & debuff.death_rot.remains < gcd.max )",
								["action"] = "death_coil",
							}, -- [13]
							{
								["enabled"] = true,
								["criteria"] = "active_enemies >= 4 & ( pet.gargoyle.active & buff.commander_of_the_dead_window.up & buff.commander_of_the_dead_window.remains > gcd.max & cooldown.apocalypse.remains < gcd.max || ( ! buff.commander_of_the_dead_window.up || buff.commander_of_the_dead_window.up & cooldown.apocalypse.remains > 5 ) & debuff.death_rot.up & debuff.death_rot.remains < gcd.max )",
								["action"] = "epidemic",
							}, -- [14]
							{
								["enabled"] = true,
							...
							{
								["enabled"] = true,
								["criteria"] = "! buff.commander_of_the_dead_window.up & ( variable.st_planning & ( ( ! talent.apocalypse.enabled || cooldown.apocalypse.remains ) & talent.morbidity.enabled || ! talent.morbidity.enabled ) || variable.adds_remain || boss & fight_remains < 21 )",
						...
						["cooldowns"] = {
							...
							{
								["enabled"] = true,
								["criteria"] = "variable.adds_remain & ( cooldown.any_dnd.remains < 10 & talent.infected_claws.enabled & ( ( cooldown.vile_contagion.remains || raid_event.adds.exists & raid_event.adds.in > 10 ) & death_knight.fwounded_targets < cycle_enemies || ! talent.vile_contagion.enabled ) & ( raid_event.adds.remains > 5 || ! raid_event.adds.exists ) || ! talent.infected_claws.enabled )",
								["action"] = "dark_transformation",
							}, -- [7]
							{
								["enabled"] = true,
						...
						["generic"] = {
							...
							{
								["enabled"] = true,
								["criteria"] = "! death_and_decay.ticking & ( active_enemies >= 2 || talent.unholy_ground.enabled ) & death_knight.fwounded_targets >= cycle_enemies",
								["action"] = "any_dnd",
							}, -- [2]
							{
								["enabled"] = true,
						...
						["covenants"] = {
							...
							{
								["enabled"] = true,
								["criteria"] = "variable.st_planning & ! soulbind.lead_by_example.enabled & ( cooldown.apocalypse.remains || ! talent.army_of_the_damned.enabled & cooldown.dark_transformation.remains ) & rune.time_to_4 > buff.runic_corruption.remains || boss & fight_remains ( soulbind.kevins_oozeling.enabled * 28 )",
								["action"] = "abomination_limb",
							}, -- [3]
							{
								["enabled"] = true,
						...
						["trinkets"] = {
							...
							}, -- [8]
							{
								...
								["slot"] = "trinket1",
								["use_off_gcd"] = 1,
								["criteria"] = "variable.trinket_1_buffs & ( ( ! talent.summon_gargoyle.enabled || talent.summon_gargoyle.enabled & pet.gargoyle.active || cooldown.summon_gargoyle.remains > 90 ) & ( pet.apoc_ghoul.active || ( ! talent.apocalypse.enabled || active_enemies >= 2 ) & buff.dark_transformation.up ) & ( variable.trinket_2_exclude || variable.trinket_priority = 1 || trinket.t2.cooldown.remains || ! trinket.t2.has_cooldown ) ) || boss & trinket.t1.buff_duration >= fight_remains",
							}, -- [9]
							{
								["enabled"] = true,
								["action"] = "trinket2",
								["slot"] = "trinket2",
								["use_off_gcd"] = 1,
								["criteria"] = "variable.trinket_2_buffs & ( ( ! talent.summon_gargoyle.enabled || talent.summon_gargoyle.enabled & pet.gargoyle.active || cooldown.summon_gargoyle.remains > 90 ) & ( pet.apoc_ghoul.active || ( ! talent.apocalypse.enabled || active_enemies >= 2 ) & buff.dark_transformation.up ) & ( variable.trinket_1_exclude || variable.trinket_priority = 2 || trinket.t1.cooldown.remains || ! trinket.t1.has_cooldown ) ) || boss & trinket.t2.buff_duration >= fight_remains",
							}, -- [10]
							{
								["enabled"] = true,
								["action"] = "trinket1",
								["slot"] = "trinket1",
								["use_off_gcd"] = 1,
								["criteria"] = "! variable.trinket_1_buffs & ( trinket.t2.cooldown.remains || ! trinket.t2.has_cooldown || ! variable.trinket_2_buffs || ! talent.summon_gargoyle.enabled || cooldown.summon_gargoyle.remains > 20 & ! pet.gargoyle.active ) || boss & fight_remains < 15",
							}, -- [11]
							{
								["enabled"] = true,
								["action"] = "trinket2",
								["slot"] = "trinket2",
								["use_off_gcd"] = 1,
								["criteria"] = "! variable.trinket_2_buffs & ( trinket.t1.cooldown.remains || ! trinket.t1.has_cooldown || ! variable.trinket_1_buffs || ! talent.summon_gargoyle.enabled || cooldown.summon_gargoyle.remains > 20 & ! pet.gargoyle.active ) || boss & fight_remains < 15",
							}, -- [12]
						},
						["aoe"] = {
							{
							...
							{
								["enabled"] = true,
								["criteria"] = "( ! talent.bursting_sores.enabled || rune < 1 || talent.bursting_sores.enabled & debuff.festering_wound.stack = 0 ) & ! variable.pooling_runic_power & ( active_enemies >= 6 || runic_power.deficit < 30 )",
								["action"] = "epidemic",
							}, -- [3]
							{
								["enabled"] = true,
						...
						["garg_setup"] = {
							{
								...
								["criteria"] = "buff.commander_of_the_dead_window.up || cooldown.dark_transformation.remains > 20 || ! talent.commander_of_the_dead.enabled & debuff.festering_wound.stack >= 4",
							}, -- [1]
							{
								["enabled"] = true,
								["criteria"] = "talent.commander_of_the_dead.enabled & ( cooldown.dark_transformation.remains < 3 || buff.commander_of_the_dead_window.up ) || ! talent.commander_of_the_dead.enabled & talent.unholy_assault.enabled & cooldown.unholy_assault.remains < 10 || ! talent.unholy_assault.enabled & ! talent.commander_of_the_dead.enabled",
								["action"] = "army_of_the_dead",
							}, -- [2]
							{
								["enabled"] = true,
							...
							{
								["enabled"] = true,
								["criteria"] = "! variable.pop_wounds & debuff.festering_wound.stack < 4 & talent.apocalypse.enabled || ! variable.pop_wounds & debuff.festering_wound.stack < 1 & ! talent.apocalypse.enabled",
								["action"] = "festering_strike",
								["cycle_targets"] = 1,
							}, -- [7]
							{
							...
							{
								["enabled"] = true,
								["criteria"] = "debuff.festering_wound.stack > 4 || debuff.festering_wound.stack >= 1 & ! talent.apocalypse.enabled",
								["action"] = "wound_spender",
								["cycle_targets"] = 1,
							}, -- [9]
						},
				...
				["Frost DK"] = {
					...
					["lists"] = {
						...
						["default"] = {
							...
							{
								["enabled"] = true,
								["criteria"] = "runic_power.deficit > 40 & incoming_magic_3s > 0",
								["action"] = "antimagic_shell",
							}, -- [13]
							{
								["enabled"] = true,
						...
						["trinkets"] = {
							{
								...
								["criteria"] = "cooldown.pillar_of_frost.remains < 2",
							...
							}, -- [1]
							{
								...
								["criteria"] = "! variable.trinket_1_manual & ( buff.pillar_of_frost.up || buff.breath_of_sindragosa.up ) & ( variable.trinket_2_exclude || ! trinket.t2.has_cooldown || trinket.t2.cooldown.remains || variable.trinket_priority = 1 ) || boss & trinket.t1.buff_duration >= fight_remains",
							}, -- [2]
							{
								["enabled"] = true,
								["criteria"] = "! variable.trinket_2_manual & ( buff.pillar_of_frost.up || buff.breath_of_sindragosa.up ) & ( variable.trinket_1_exclude || ! trinket.t1.has_cooldown || trinket.t1.cooldown.remains || variable.trinket_priority = 2 ) || boss & trinket.t2.buff_duration >= fight_remains",
								["action"] = "trinket2",
								["slot"] = "trinket2",
							}, -- [3]
							{
					...
					["lists"] = {
						...
						["default"] = {
							...
							}, -- [2]
							{
								["enabled"] = true,
								["action"] = "call_action_list",
								["criteria"] = "talent.summon_demonic_tyrant.enabled & ( ( variable.next_tyrant - time ) <= ( variable.tyrant_prep_start + 2 ) & cooldown.summon_demonic_tyrant.up || cooldown.summon_demonic_tyrant.remains_expected <= variable.tyrant_prep_start )",
								["list_name"] = "tyrant",
							}, -- [3]
							{
								["enabled"] = true,
							...
							{
								["enabled"] = true,
								["criteria"] = "cooldown.demonic_strength.remains",
								["action"] = "guillotine",
							}, -- [13]
							{
							...
							{
								["enabled"] = true,
								["criteria"] = "active_enemies = 1 & last_cast_imps > 0 & buff.tyrant.down & talent.imp_gang_boss.enabled & ! talent.sacrificed_souls.enabled",
								["action"] = "implosion",
							}, -- [19]
							{
								["enabled"] = true,
							...
							{
								["enabled"] = true,
								["criteria"] = "active_enemies > 1 & buff.tormented_soul.stack = 10",
								["action"] = "summon_soulkeeper",
							}, -- [21]
							{
								["enabled"] = true,
								["criteria"] = "buff.demonic_core.up & soul_shard < 4",
								["action"] = "demonbolt",
							}, -- [22]
							{
								["enabled"] = true,
								["criteria"] = "buff.demonic_core.stack < 1 & ( buff.dreadstalkers.remains > 3 || buff.dreadstalkers.down )",
								["action"] = "power_siphon",
							}, -- [23]
							{
								["enabled"] = true,
								["criteria"] = "soul_shard > 2 & ( ! talent.summon_demonic_tyrant.enabled || cooldown.summon_demonic_tyrant.remains_expected > variable.tyrant_prep_start + 2 )",
								["action"] = "hand_of_guldan",
							}, -- [24]
							{
								["enabled"] = true,
						...
						["precombat"] = {
							...
							{
								["enabled"] = true,
								["criteria"] = "soul_shards < 5 & ( boss || action.demonbolt.cast = 0 & ! buff.power_siphon.up )",
								["action"] = "demonbolt",
							}, -- [5]
							{
								["enabled"] = true,
						...
						["tyrant"] = {
							...
							{
								["enabled"] = true,
								["criteria"] = "variable.next_tyrant - time > 2 & ( buff.nether_portal.up || soul_shard > 2 & variable.next_tyrant - time < 12 || soul_shard = 5 )",
								["action"] = "hand_of_guldan",
							}, -- [7]
							{
								["enabled"] = true,
								["criteria"] = "talent.soulbound_tyrant.enabled & variable.next_tyrant - time < 4 & variable.next_tyrant - time > action.summon_demonic_tyrant.cast_time",
								["action"] = "hand_of_guldan",
							}, -- [8]
							{
								["enabled"] = true,
								["criteria"] = "variable.next_tyrant - time < cast_time * 2",
				...
				["Marksmanship"] = {
					...
					["lists"] = {
						["trickshots"] = {
							...
							{
								["enabled"] = true,
								["criteria"] = "cooldown.rapid_fire.remains < gcd.max || ! talent.streamline.enabled",
								["action"] = "double_tap",
							}, -- [3]
							{
								["enabled"] = true,
							...
							{
								["enabled"] = true,
								["criteria"] = "buff.trick_shots.remains >= execute_time & ( talent.surging_shots.enabled || buff.double_tap.up & talent.streamline.enabled )",
								["action"] = "rapid_fire",
							}, -- [13]
							{
								["enabled"] = true,
						...
						["st"] = {
							...
							{
								["enabled"] = true,
								["description"] = "Save Double Tap for Rapid Fire if at least Streamline is taken.",
								["criteria"] = "( cooldown.rapid_fire.remains < gcd.max || ! talent.streamline.enabled ) & ( ! raid_event.adds.exists || raid_event.adds.up & ( raid_event.adds.in < 10 & raid_event.adds.remains < 3 || raid_event.adds.in > action_cooldown || active_enemies > 1 ) || ! raid_event.adds.up & ( raid_event.adds.count = 1 || raid_event.adds.in > action_cooldown ) )",
								["action"] = "double_tap",
							}, -- [6]
							{
								["action"] = "stampede",
							...
							{
								["enabled"] = true,
								["description"] = "With at least Streamline, Double Tap Rapid Fire.",
								["criteria"] = "talent.surging_shots.enabled || buff.double_tap.up & talent.streamline.enabled",
								["action"] = "rapid_fire",
							}, -- [11]
							{
								["enabled"] = true,
					...
					["lists"] = {
						["items"] = {
							...
							}, -- [2]
							{
								["enabled"] = true,
								["action"] = "trinket1",
								["criteria"] = "( ! talent.rain_of_chaos.enabled & boss & fight_remains < cooldown.summon_infernal.remains + trinket.t1.cooldown.duration & time_to_die > trinket.t1.cooldown.duration ) || boss & fight_remains < cooldown.summon_infernal.remains || ( trinket.t2.cooldown.remains > 0 & trinket.t2.cooldown.remains < cooldown.summon_infernal.remains )",
								["slot"] = "trinket1",
							}, -- [3]
							{
								["enabled"] = true,
								["action"] = "trinket2",
								["criteria"] = "( ! talent.rain_of_chaos.enabled & boss & fight_remains < cooldown.summon_infernal.remains + trinket.t2.cooldown.duration & time_to_die > trinket.t2.cooldown.duration ) || boss & fight_remains < cooldown.summon_infernal.remains || ( trinket.t1.cooldown.remains > 0 & trinket.t1.cooldown.remains < cooldown.summon_infernal.remains )",
								["slot"] = "trinket2",
							}, -- [4]
							{
								["enabled"] = true,
								["criteria"] = "( ! talent.rain_of_chaos.enabled & boss & fight_remains < cooldown.summon_infernal.remains + cooldown.erupting_spear_fragment.duration & time_to_die > cooldown.erupting_spear_fragment.duration ) || boss & fight_remains < cooldown.summon_infernal.remains || cooldown.erupting_spear_fragment.duration < cooldown.summon_infernal.remains + 5",
						...
						["default"] = {
							...
							{
								["enabled"] = true,
								["criteria"] = "( active_enemies >= 3 - ( talent.inferno.enabled & ! talent.madness_of_the_azjaqir.enabled ) ) & ! ( ! talent.inferno.enabled & talent.madness_of_the_azjaqir.enabled & talent.chaos_incarnate.enabled & active_enemies < 4 )",
								["action"] = "call_action_list",
								["list_name"] = "aoe",
							}, -- [4]
							{
							...
							{
								["enabled"] = true,
								["criteria"] = "( ( dot.immolate.refreshable & talent.internal_combustion.enabled ) || dot.immolate.remains < 3 ) & ( ! talent.cataclysm.enabled || cooldown.cataclysm.remains > dot.immolate.remains ) & ( ! talent.soul_fire.enabled || cooldown.soul_fire.remains + action.soul_fire.cast_time > dot.immolate.remains ) & target.time_to_die > 8",
								["action"] = "immolate",
							}, -- [10]
							{
								["enabled"] = true,
							...
							{
								["enabled"] = true,
								["criteria"] = "buff.burn_to_ashes.up & cast_time + action.chaos_bolt.cast_time < buff.madness_cb.remains",
								["action"] = "incinerate",
							}, -- [16]
							{
								["enabled"] = true,
						...
						["aoe"] = {
							{
								...
								["action"] = "call_action_list",
								["strict"] = 1,
								["criteria"] = "havoc_active & havoc_remains > gcd.max & active_enemies < 5 + ( talent.cry_havoc.enabled & ! talent.inferno.enabled )",
								["list_name"] = "havoc",
							}, -- [1]
							{
								["enabled"] = true,
							...
							}, -- [7]
							{
								["enabled"] = true,
								["action"] = "immolate",
								["criteria"] = "dot.immolate.remains < 5 & ( ! talent.cataclysm.enabled || cooldown.cataclysm.remains > dot.immolate.remains ) & ( ! talent.raging_demonfire.enabled || cooldown.channel_demonfire.remains > remains ) & active_dot.immolate <= 4 & ! havoc_active & target.time_to_die > 8",
								["cycle_targets"] = 1,
							}, -- [8]
							{
								["enabled"] = true,
							...
							{
								["enabled"] = true,
								["criteria"] = "( debuff.pyrogenics.down || buff.madness_rof.up ) & active_enemies <= 4",
								["action"] = "rain_of_fire",
							}, -- [11]
							{
								["enabled"] = true,
							...
							}, -- [13]
							{
								["enabled"] = true,
								["action"] = "immolate",
								["criteria"] = "( ( dot.immolate.remains < 3 & ( ! talent.cataclysm.enabled || cooldown.cataclysm.remains > dot.immolate.remains ) ) || cycle_enemies > active_dot.immolate ) & target.time_to_die > 8",
								["cycle_targets"] = 1,
							}, -- [14]
							{
								["enabled"] = true,
						...
						["havoc"] = {
							...
							}, -- [3]
							{
								["enabled"] = true,
								["action"] = "immolate",
								["criteria"] = "( dot.immolate.refreshable & dot.immolate.remains < havoc_remains || ! dot.immolate.ticking ) & soul_shard < 4.5 & target.time_to_die > 8",
								["cycle_targets"] = 1,
							}, -- [4]
							{
								["enabled"] = true,
							...
							{
								["enabled"] = true,
								["criteria"] = "active_enemies > 1 & ( talent.avatar_of_destruction.enabled || ( talent.rain_of_chaos.enabled & buff.rain_of_chaos.up ) ) & talent.inferno.enabled",
								["action"] = "rain_of_fire",
							}, -- [9]
							{
								["enabled"] = true,
						...
						["cleave"] = {
							...
							}, -- [7]
							{
								["enabled"] = true,
								["action"] = "immolate",
								["criteria"] = "refreshable & ( ( talent.internal_combustion.enabled & dot.immolate.refreshable ) || dot.immolate.remains < 3 ) & ( ! talent.cataclysm.enabled || cooldown.cataclysm.remains > remains ) & ( ! talent.soul_fire.enabled || cooldown.soul_fire.remains + ( ! talent.mayhem.enabled * action.soul_fire.cast_time ) > dot.immolate.remains ) & time_to_die > 8",
								["cycle_targets"] = 1,
							}, -- [8]
							{
								["enabled"] = true,
							...
							{
								["enabled"] = true,
								["criteria"] = "buff.tormented_soul.stack = 10 || buff.tormented_soul.stack > 3 & time_to_die < 10",
								["action"] = "summon_soulkeeper",
							}, -- [25]
							{
								["enabled"] = true,
				...
				["Affliction"] = {
					...
					["lists"] = {
						...
						["default"] = {
							...
							{
								["enabled"] = true,
								["criteria"] = "! talent.soul_rot.enabled || cooldown.soul_rot.remains <= execute_time || ! talent.summon_darkglare.enabled",
							...
							{
								["enabled"] = true,
								["criteria"] = "variable.ps_up & variable.vt_up || ! talent.summon_darkglare.enabled",
								["action"] = "soul_rot",
							}, -- [16]
							{
								["enabled"] = true,
							...
							{
								["enabled"] = true,
								["criteria"] = "variable.cd_dots_up || dot.vile_taint_dot.ticking & soul_shard > 1",
								["action"] = "malefic_rapture",
							}, -- [23]
							{
								["enabled"] = true,
					...
					["lists"] = {
						["drw_up"] = {
							...
							}, -- [3]
							{
								...
								["description"] = "Use Death's Caress if",
						...
						["default"] = {
							...
							}, -- [8]
							{
								...
								["description"] = "Use Vampiric Blood if you're taking sufficient damage and you don't have Dancing Rune Weapon or Icebound Fortitude up.",
							...
							}, -- [12]
							{
								["enabled"] = true,
								["action"] = "death_and_decay",
								["description"] = "Use Death and Decay if it's not already up and you have 4 targets, Unholy Ground, or Sanguine Ground or with Crimson Scourge.",
				...
				["Enhancement"] = {
					...
					["lists"] = {
						["single"] = {
							...
							{
								["enabled"] = true,
								["criteria"] = "buff.maelstrom_weapon.stack >= 5 & buff.primordial_wave.up & ( buff.primordial_wave.remains < 1.5 * gcd.max || raid_event.adds.in > buff.primordial_wave.remains & ( ! buff.splintered_elements.up || fight_remains <= 12 ) )",
								["action"] = "lightning_bolt",
							}, -- [11]
							{
								["enabled"] = true,
						...
						["aoe"] = {
							...
							{
								["enabled"] = true,
								["criteria"] = "( active_dot.flame_shock >= active_enemies || active_dot.flame_shock > 5 ) & buff.primordial_wave.up & ( buff.primordial_wave.remains < 1.5 * gcd.max || buff.maelstrom_weapon.stack >= ( 5 + 5 * talent.overflowing_maelstrom.enabled ) ) & ( ! buff.splintered_elements.up || fight_remains <= 12 || raid_event.adds.remains <= gcd.max )",
								["action"] = "lightning_bolt",
							}, -- [2]
							{
								["enabled"] = true,
				...
				["Brewmaster"] = {
					...
					["lists"] = {
						...
						["rotation_boc"] = {
							...
							{
								["enabled"] = true,
								["criteria"] = "energy + energy.regen * ( variable.time_to_scheduled_ks + execute_time ) >= 65",
								["action"] = "black_ox_brew",
							}, -- [7]
							{
								["enabled"] = true,
				...
				["Survival"] = {
					...
					["lists"] = {
						...
						["cds"] = {
							...
							{
								["enabled"] = true,
								["criteria"] = "target.boss & fight_remains < 30 || buff.coordinated_assault.up || buff.spearhead.up || ! talent.spearhead.enabled & ! talent.coordinated_assault.enabled",
								["action"] = "potion",
							}, -- [9]
							{
								["action"] = "use_items",
						...
						["st"] = {
							...
							{
								["enabled"] = true,
								["criteria"] = "next_wi_bomb.pheromone & ! buff.mongoose_fury.up & focus + cast_regen < focus.max - action.kill_command.cast_regen * 2 || buff.coordinated_assault.up & focus + cast_regen < focus.max & talent.coordinated_kill.rank > 1",
								["action"] = "wildfire_bomb",
							}, -- [14]
							{
								["enabled"] = true,
								["action"] = "kill_command",
								["criteria"] = "full_recharge_time < gcd.max & focus + cast_regen < focus.max",
								["cycle_targets"] = 1,
							}, -- [15]
							{
								["enabled"] = true,
							...
							}, -- [21]
							{
								["enabled"] = true,
								["action"] = "mongoose_bite",
								["criteria"] = "focus + action.kill_command.cast_regen > focus.max - 10",
								["cycle_targets"] = 1,
							}, -- [22]
							{
								["enabled"] = true,
