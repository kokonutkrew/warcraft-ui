...
Postal3DB = {
	...
	["global"] = {
		["BlackBook"] = {
			["alts"] = {
				"Buhbles|Emerald Dream|Alliance|2|MONK", -- [1]
				"Dethwish|Emerald Dream|Alliance|8|DEATHKNIGHT", -- [2]
				"Royders|Emerald Dream|Alliance|1|ROGUE", -- [3]
				"Samoanbatman|Emerald Dream|Alliance|50|DEMONHUNTER", -- [4]
				"Samoanbeast|Ravenholdt|Alliance|1|DRUID", -- [5]
				"Samoansage|Tichondrius|Horde|110|DRUID", -- [6]
				"Samoansavage|Stormrage|Alliance|115|DRUID", -- [7]
				"Samoanslayer|Emerald Dream|Alliance|1|WARRIOR", -- [8]
				"Samoanstrap|Tichondrius|Horde|110|HUNTER", -- [9]
				"Samoantank|Tichondrius|Horde|112|PALADIN", -- [10]
				"Samoantitan|Stormrage|Alliance|120|PALADIN", -- [11]
			},
		},
	},
	["profiles"] = {
