...
function E:CreateFontObjects()
	...
	self.NpName = CreateFont("NpName-OmniAuras")
	self.NpName:CopyFontObject("GameFontHighlightSmall")
	self.NpIndicator = CreateFont("NpIndicator-OmniAuras")
	self.NpIndicator:CopyFontObject("GameFontHighlight")
...
function E:UpdateFontObjects()
	...
	self:SetFontProperties(self.NpName, self.profile.General.fonts.npName)
	self:SetFontProperties(self.NpIndicator, self.profile.General.fonts.npIndicator)
end
