...
function FFWhisperLogScrollBar_Update()
   ...
   for LogLine=1,8 do
      ...
      if LogLinePlusOffset <= table.getn(FF_Whisper_Log) then
         _G["FFLogDate"..LogLine.."ButtonTextName"]:SetText(FF_ColourText(FF_Whisper_Log[LogLinePlusOffset]["Date"], "white"));
         _G["FFLogCommand"..LogLine.."ButtonTextName"]:SetText(FF_ColourText(FF_Whisper_Log[LogLinePlusOffset]["Command"], "white"));
         _G["FFLogName"..LogLine.."ButtonTextName"]:SetText(FF_ColourText(FF_Whisper_Log[LogLinePlusOffset]["Name"], "white"));
         _G["FFLogAuthorised"..LogLine.."ButtonTextName"]:SetText(FF_ColourText(FF_Whisper_Log[LogLinePlusOffset]["Authorised"], "white"));
         _G["FFLogDate"..LogLine]:Show();
         _G["FFLogCommand"..LogLine]:Show();
         _G["FFLogName"..LogLine]:Show();
         _G["FFLogAuthorised"..LogLine]:Show();
      else
         _G["FFLogDate"..LogLine]:Hide();
         _G["FFLogCommand"..LogLine]:Hide();
         _G["FFLogName"..LogLine]:Hide();
         _G["FFLogAuthorised"..LogLine]:Hide();
      end
...
function FFWhisperLog_HighlightHeader()
    ...
    for i=1, table.getn(FFWhisperLog_Headers) do
        if (FF_Options["WhisperLogSettings"]["OrderBy"] == FFWhisperLog_Headers[i][1]) then
            _G["FFWhisperLog_lbl"..FFWhisperLog_Headers[i][1].."Label"]:SetText(FF_ColourText(FFWhisperLog_Headers[i][2], "green"));
        else
            _G["FFWhisperLog_lbl"..FFWhisperLog_Headers[i][1].."Label"]:SetText(FFWhisperLog_Headers[i][2]);
        end
