isboxer.Character.Name = "Samoandruid";
isboxer.Character.ActualName = "Samoandruid";
isboxer.Character.QualifiedName = "Samoandruid-Emerald Dream";
...
isboxer.Output("Character 'Samoandruid' activated");
