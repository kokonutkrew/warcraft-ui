...
<<<<<<<< Updated upstream:_retail_/Interface/AddOns/GladiatorlosSA2/Libs/AceGUI-3.0-SharedMediaWidgets/prototypes.lua
			frame = CreateFrame("Frame", nil, UIParent)
========
			frame = CreateFrame("Frame", nil, UIParent, BackdropTemplateMixin and "BackdropTemplate" or nil)
>>>>>>>> Stashed changes:_retail_/Interface/AddOns/RareScanner/ExternalLibs/AceGUI-3.0-SharedMediaWidgets/prototypes.lua
