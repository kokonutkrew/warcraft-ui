...
L["Shal'Aran"] = "沙尔艾兰"
L["Show cursor and character coordinates"] = "显示鼠标及玩家坐标信息"
L["Show map reveal toggle button"] = "显示去除地图迷雾的按钮"
L["Show older dungeon location icons"] = "显示旧世地下城位置图标"
...
L["Use large font for character coordinates"] = "为玩家坐标使用大号字体"
...
L["Shadowmoon Burial Grounds"] = "影月墓地"
L["Shal'Aran"] = "沙亞蘭"
L["Show cursor and character coordinates"] = "顯示滑鼠與角色的座標"
L["Show map reveal toggle button"] = "顯示地圖顯露切換按紐"
L["Show older dungeon location icons"] = "顯示舊地城位置圖示"
...
L["Use large font for character coordinates"] = "角色座標使用大字體"
...
L["Shal'Aran"] = "샬아란"
L["Show cursor and character coordinates"] = "커서 및 케릭터의 좌표 표시"
L["Show map reveal toggle button"] = "미탐험 지역 밝힘 버튼 표시"
L["Show older dungeon location icons"] = "옛 던전 위치 아이콘 표시"
...
L["Use large font for character coordinates"] = "자신의 좌표 큰글자 사용"
