...
BugGrabberDB = {
	...
	["errors"] = {
		{
			["message"] = "...unt\\384591484#1\\Emerald Dream\\Samoanrouge\\SavedVariables\\Auctionator-5.0.5.lua:1: unexpected symbol",
			["time"] = "2018/12/11 16:52:12",
			["locals"] = "",
			["stack"] = "",
			["session"] = 1,
			["counter"] = 2,
		...
		{
			["message"] = "...ccount\\384591484#1\\Emerald Dream\\Samoanrouge\\SavedVariables\\DBM-Core-8.0.17.lua:1: unexpected symbol",
			["time"] = "2018/12/11 16:52:15",
			["locals"] = "",
			["stack"] = "",
			["session"] = 1,
			["counter"] = 2,
		...
		{
			["message"] = "WTF\\Account\\384591484#1\\Emerald Dream\\Samoanrouge\\SavedVariables\\MBB-4.0.lua:1: unexpected symbol",
			["time"] = "2018/12/11 16:52:21",
			["locals"] = "",
			["stack"] = "",
			["session"] = 1,
			["counter"] = 2,
		...
		{
			["message"] = "...TF\\Account\\384591484#1\\Emerald Dream\\Samoanrouge\\SavedVariables\\Pawn-2.2.31.lua:1: unexpected symbol",
			["time"] = "2018/12/11 16:52:23",
			["locals"] = "",
			["stack"] = "",
			["session"] = 1,
			["counter"] = 2,
		...
		{
			["message"] = "...erald Dream\\Samoanrouge\\SavedVariables\\Blizzard_ClientSavedVariables.lua:1: unexpected symbol",
			["session"] = 1,
			["time"] = "2018/12/11 16:52:31",
			["counter"] = 2,
		}, -- [5]
		{
			["message"] = "...1484#1\\Emerald Dream\\Samoanrouge\\SavedVariables\\Blizzard_TimeManager.lua:1: unexpected symbol",
			["time"] = "2018/12/11 16:52:38",
			["locals"] = "(*temporary) = \"Blizzard_TimeManager\"\n",
			["stack"] = "[C]: in function `LoadAddOn'\nInterface\\FrameXML\\UIParent.lua:449: in function `UIParentLoadAddOn'\nInterface\\FrameXML\\UIParent.lua:568: in function `TimeManager_LoadUI'\nInterface\\FrameXML\\UIParent.lua:1195: in function <Interface\\FrameXML\\UIParent.lua:1093>",
			["session"] = 1,
			["counter"] = 3,
		}, -- [6]
		{
			["message"] = "Interface\\AddOns\\WeakAuras\\Locales\\ruRU-Russian.lua:616: unfinished long string near '<eof>'",
			["time"] = "2018/12/12 21:14:41",
			["locals"] = "",
			["stack"] = "",
			["session"] = 8,
			["counter"] = 15,
