				...
				["Shadow"] = {
					...
					["lists"] = {
						...
						["main"] = {
							...
							{
								["enabled"] = true,
								["criteria"] = "fight_remains < 30 || time_to_die > 15 & ( ! variable.holding_crash || spell_targets.mind_sear > 2 )",
								["action"] = "call_action_list",
								["list_name"] = "cds",
							}, -- [2]
							{
							...
							}, -- [17]
							{
								...
								["action"] = "void_torrent",
								["cycle_targets"] = 1,
								["criteria"] = "variable.all_dots_up & insanity <= 35 & ! variable.holding_crash",
								["description"] = "TODO: Dont use if add events are coming soon when talented into PL",
							}, -- [18]
							{
								["enabled"] = true,
						...
						["aoe"] = {
							...
							}, -- [1]
							{
								["enabled"] = true,
								["action"] = "vampiric_touch",
								["criteria"] = "refreshable & target.time_to_die >= 18 & ( dot.vampiric_touch.ticking || ! variable.vts_applied ) & variable.max_vts > 0 & ! variable.manual_vts_applied",
								["cycle_targets"] = 1,
							}, -- [2]
							{
								["enabled"] = true,
							...
							{
								["enabled"] = true,
								["criteria"] = "ptr = 1 & talent.void_torrent.enabled & talent.psychic_link.enabled & cooldown.void_torrent.remains <= 3 & ( ! variable.holding_crash || raid_event.adds.count / ( active_dot.vampiric_touch + raid_event.adds.count ) < 1.5 ) & ( ( insanity >= 50 || dot.devouring_plague.ticking || buff.dark_reveries.up ) || buff.voidform.up )",
								["action"] = "call_action_list",
							...
							}, -- [18]
							{
								["enabled"] = true,
								["action"] = "void_torrent",
								["criteria"] = "insanity <= 35 & ! talent.psychic_link.enabled & variable.dots_up",
								["cycle_targets"] = 1,
							}, -- [19]
							{
								["enabled"] = true,
						...
						["pl_torrent"] = {
							...
							{
								["enabled"] = true,
								["criteria"] = "remains <= 4 & cooldown.void_torrent.remains < gcd.max * 2 & ! buff.voidform.up & ( spell_targets.mind_sear <= 4 || ! talent.surge_of_darkness.enabled & cooldown.mind_blast.full_recharge_time >= 3 ) & ! buff.mind_devourer.up",
								["action"] = "devouring_plague",
							}, -- [3]
							{
								["enabled"] = true,
								["criteria"] = "! variable.dp_cutoff || buff.mind_devourer.up",
								["action"] = "mind_sear",
							}, -- [4]
							{
								["enabled"] = true,
					...
					["lists"] = {
						...
						["default"] = {
							...
							}, -- [2]
							{
								...
								["action"] = "call_action_list",
								["strict"] = 1,
								["criteria"] = "active_enemies > 1 & active_enemies < 4",
								["list_name"] = "cleave",
							}, -- [3]
							{
								["enabled"] = true,
							...
							{
								["enabled"] = true,
								["criteria"] = "dot.unstable_affliction.remains < 5",
								["action"] = "soul_swap",
							}, -- [7]
							{
								["enabled"] = true,
							...
							{
								["enabled"] = true,
								["criteria"] = "! talent.dread_touch.enabled & ( dot.soul_rot.remains > cast_time || dot.phantom_singularity.remains > cast_time || dot.vile_taint.remains > cast_time || pet.darkglare.active )",
								["action"] = "malefic_rapture",
							}, -- [20]
							{
								["enabled"] = true,
								["criteria"] = "buff.nightfall.react || talent.shadow_embrace.enabled & ( debuff.shadow_embrace.stack < 3 || debuff.shadow_embrace.remains < 2 )",
								["action"] = "drain_soul",
							}, -- [21]
							{
								["enabled"] = true,
						...
						["precombat"] = {
							...
							{
								["enabled"] = true,
								["criteria"] = "active_dot.unstable_affliction = 0 & ! talent.soul_swap.enabled",
								["action"] = "unstable_affliction",
							}, -- [7]
							{
								["action"] = "shadow_bolt",
						...
						["ogcd"] = {
							{
								["enabled"] = true,
								["criteria"] = "pet.darkglare.active || dot.soul_rot.ticking || ! talent.summon_darkglare.enabled & ! talent.soul_rot.enabled",
								["action"] = "potion",
							}, -- [1]
							{
								["enabled"] = true,
				...
				["Destruction"] = {
					...
					["lists"] = {
						["items"] = {
							{
								["enabled"] = true,
								["action"] = "trinket1",
								["criteria"] = "pet.infernal.active || ! talent.summon_infernal.enabled || boss & fight_remains < 21 || trinket.t1.cooldown.duration < cooldown.summon_infernal.remains",
								["slot"] = "trinket1",
							}, -- [1]
							{
								["enabled"] = true,
								["action"] = "trinket2",
								["criteria"] = "pet.infernal.active || ! talent.summon_infernal.enabled || boss & fight_remains < 21 || trinket.t2.cooldown.duration < cooldown.summon_infernal.remains",
								["slot"] = "trinket2",
							}, -- [2]
							{
								["enabled"] = true,
								...
								["description"] = "We might use trinket outside of infernal to not lose a use if we don't have RoC",
							}, -- [3]
							{
								["enabled"] = true,
								["action"] = "trinket2",
						...
						["default"] = {
							...
							{
								["enabled"] = true,
								["criteria"] = "talent.cry_havoc.enabled & ( buff.ritual_of_ruin.up || pet.infernal.active )",
								["action"] = "havoc",
							}, -- [12]
							{
								["enabled"] = true,
						...
						["aoe"] = {
							...
							}, -- [7]
							{
								["enabled"] = true,
								["action"] = "immolate",
								["criteria"] = "dot.immolate.remains < 5 & ( ! talent.cataclysm.enabled || cooldown.cataclysm.remains > dot.immolate.remains ) & ( ! talent.raging_demonfire.enabled || cooldown.channel_demonfire.remains > remains ) & active_dot.immolate <= 6",
								["cycle_targets"] = 1,
							}, -- [8]
							{
								["enabled"] = true,
						...
						["havoc"] = {
							...
							{
								["enabled"] = true,
								["criteria"] = "talent.cry_havoc.enabled & ! talent.inferno.enabled & cast_time < havoc_remains",
								["action"] = "chaos_bolt",
							}, -- [5]
							{
								["enabled"] = true,
								["criteria"] = "cast_time < havoc_remains & ( active_enemies < 4 - talent.inferno.enabled + talent.madness_of_the_azjaqir.enabled - ( talent.inferno.enabled & ( talent.rain_of_chaos.enabled || talent.avatar_of_destruction.enabled ) & buff.rain_of_chaos.up ) )",
								["action"] = "chaos_bolt",
							}, -- [6]
							{
								["enabled"] = true,
				...
				["Demonology"] = {
					...
					["lists"] = {
						...
						["default"] = {
							...
							{
								["enabled"] = true,
								["criteria"] = "talent.summon_demonic_tyrant.enabled & ( variable.next_tyrant - time ) <= ( variable.tyrant_prep_start + 2 ) & cooldown.summon_demonic_tyrant.up || talent.summon_demonic_tyrant.enabled & cooldown.summon_demonic_tyrant.remains_expected <= variable.tyrant_prep_start",
								["action"] = "call_action_list",
								["list_name"] = "tyrant",
							}, -- [3]
							{
							...
							{
								["enabled"] = true,
								["criteria"] = "active_enemies > 2 & buff.wild_imps.stack >= 6",
								["action"] = "implosion",
							}, -- [17]
							{
								["enabled"] = true,
