...
FFSLASH_USE_GMOUNT_USAGE = "Usage: "..FFSLASH_USE_GMOUNT.." Mount Name to set mount (E.g. "..FFSLASH_USE_GMOUNT.." Mechano Hog). "..FFSLASH_USE_GMOUNT.." clear to clear prefered mount. NOTE: You can link (shift click) a mount instead of typing its name.";
...
FFSLASH_USE_FMOUNT_USAGE = "Usage: "..FFSLASH_USE_FMOUNT.." Mount Name to set mount (E.g. "..FFSLASH_USE_FMOUNT.." Swift Red Windrider). "..FFSLASH_USE_FMOUNT.." clear to clear prefered mount. NOTE: You can link (shift click) a mount instead of typing its name.";
...
FFSLASH_SET_MASTER = "/ff_SetMaster";
FFSLASH_SET_MASTER_ALIAS = "/ff_sm";
FFSLASH_SET_MASTER_USAGE = "Usage: "..FFSLASH_SET_MASTER.." Master's Name (E.g. "..FFSLASH_SET_MASTER.." Felankor)";
FFSLASH_SET_MASTER_HELP = FFSLASH_SET_MASTER.." (Alias: "..FFSLASH_SET_MASTER_ALIAS.."): Sets a player as your DualBox Master.";
FFSLASH_SET_MASTER_HELPDIALOG = FFHELPDIALOG_COMMAND_COLOUR..FFSLASH_SET_MASTER.." (Alias: "..FFSLASH_SET_MASTER_ALIAS.."): "..FFHELPDIALOG_DESCRIPTION_COLOUR.."Sets a player as your DualBox Master.";

FFSLASH_CLEAR_MASTER = "/ff_ClearMaster";
FFSLASH_CLEAR_MASTER_HELP = FFSLASH_CLEAR_MASTER..": Clears your DualBox Master.";
FFSLASH_CLEAR_MASTER_HELPDIALOG = FFHELPDIALOG_COMMAND_COLOUR..FFSLASH_CLEAR_MASTER..": "..FFHELPDIALOG_DESCRIPTION_COLOUR.." Clears your DualBox Master.";

FFSLASH_CANCEL_RESUME_FOLLOW = "/ff_CancelResumeFollow";
FFSLASH_CANCEL_RESUME_FOLLOW_ALIAS = "/ff_CRF";
FFSLASH_CANCEL_RESUME_FOLLOW_HELP = FFSLASH_CANCEL_RESUME_FOLLOW.." (Alias: "..FFSLASH_CANCEL_RESUME_FOLLOW_ALIAS.."): Cancels Auto Resume Follow after combat.";
FFSLASH_CANCEL_RESUME_FOLLOW_HELPDIALOG = FFHELPDIALOG_COMMAND_COLOUR..FFSLASH_CANCEL_RESUME_FOLLOW.." (Alias: "..FFSLASH_CANCEL_RESUME_FOLLOW_ALIAS.."): "..FFHELPDIALOG_DESCRIPTION_COLOUR.."Cancels Auto Resume Follow after combat.";
...
FFMSG_CANT_FOLLOW = "I can't follow you. You're not in my group/raid.";
...
--DualBox Messages
FFMSG_MASTER_CLEARED = "DualBox Master cleared.";
FFMSG_QUEST_ACCEPTED = "Quest Accepted";
FFMSG_AUTO_RESUME_FOLLOW_CANCELED = "Auto Resume Follow has been canceled until the next time you follow somebody."
...
FFMSG_RESURRECT_AUTO_ACCEPTED_WHISPER = "Automatically accepted resurrect from you.";
...
--Partial DualBox Messages
FFMSG_MASTER_SET = "DualBox Master set to: ";
FFMSG_HAS_LOW_HEALTH = " has low health!";
...
FFMINIMAP_TOOLTIP_LEFT2 = "Move Minimap Button";
FFMINIMAP_TOOLTIP_RIGHT2 = "Right-Click + Drag";
FFMINIMAP_TOOLTIP_LEFT3 = "Current DualBox Master:";
FFMINIMAP_TOOLTIP_LEFT4 = "Preferred Flying Mount:"
FFMINIMAP_TOOLTIP_LEFT5 = "Preferred Ground Mount:"
FFMINIMAP_TOOLTIP_NOT_SET = "Not Set";
...
FFOPTIONS_GUILD = FFOPTIONSPANELS_TEXT_COLOUR.."Guild"..FF_END_COLOUR;
FFOPTIONS_FRIENDS = FFOPTIONSPANELS_TEXT_COLOUR.."Friends"..FF_END_COLOUR;
FFOPTIONS_GROUP = FFOPTIONSPANELS_TEXT_COLOUR.."Group"..FF_END_COLOUR;
FFOPTIONS_RAID = FFOPTIONSPANELS_TEXT_COLOUR.."Raid"..FF_END_COLOUR;
FFOPTIONS_MASTER = FFOPTIONSPANELS_TEXT_COLOUR.."Master"..FF_END_COLOUR;
FFOPTIONS_MASTER_TOOLTIP = "You can set your DualBox Master using the "..FFSLASH_SET_MASTER.." command.";
...
FFOPTIONS_ALLOW_INVITE_REQUESTS = FFOPTIONSPANELS_TEXT_COLOUR.."Enable Invite Requests From:"..FF_END_COLOUR;
FFOPTIONS_ALLOW_INVITE_REQUESTS_TOOLTIP = "Enables use of the "..FFWHISP_INVITE_ME.." whisper command.";
FFOPTIONS_AUTO_ACCEPT_PARTY = FFOPTIONSPANELS_TEXT_COLOUR.."Enable Auto Accept Group Invites From:"..FF_END_COLOUR;
FFOPTIONS_AUTO_ACCEPT_PARTY_TOOLTIP = "Enables auto accept group invites.";
FFOPTIONS_AUTO_ACCEPT_RESURRECT = FFOPTIONSPANELS_TEXT_COLOUR.."Enable Auto Accept Resurrect From:"..FF_END_COLOUR;
FFOPTIONS_AUTO_ACCEPT_RESURRECT_TOOLTIP = "Enables auto accept resurrect.";
...
FFOPTIONS_ALLOW_EMOTE_COMMAND = FFOPTIONSPANELS_TEXT_COLOUR.."Enable Emote Command From:"..FF_END_COLOUR;
FFOPTIONS_ALLOW_EMOTE_COMMAND_TOOLTIP = "Enables use of the "..FFWHISP_EMOTE.." whisper command.";
...
--DualBox panel
FFOPTIONS_DUALBOX_PANEL = "Dual Boxing";
FFOPTIONS_DUALBOX_DESCRIPTION1 = FFOPTIONSPANELS_TEXT_COLOUR.."Tip: Dual Boxing is when you play 2 or more characters at the same time."..FF_END_COLOUR;
FFOPTIONS_DUALBOX_DESCRIPTION2 = FFOPTIONSPANELS_TEXT_COLOUR.."Note: For some of these options to work you must first set your DualBox\nMaster using the "..FFSLASH_SET_MASTER.." command. Type "..FFSLASH_SHOW_HELP.." for more\ninformation."..FF_END_COLOUR;

FFOPTIONS_RESUME_FOLLOW = FFOPTIONSPANELS_TEXT_COLOUR.."Auto Resume Follow After Combat"..FF_END_COLOUR;
FFOPTIONS_RESUME_FOLLOW_TOOLTIP = "Automatically resumes following the last person you followed after combat.";
FFOPTIONS_CANCEL_RESUME_ON_CAST = FFOPTIONSPANELS_TEXT_COLOUR.."Cancel Auto Resume Follow On Spell Cast"..FF_END_COLOUR;
FFOPTIONS_CANCEL_RESUME_ON_CAST_TOOLTIP = "Cancels Auto Resume Follow when you cast a spell.";
FFOPTIONS_ACCEPT_QUESTS = FFOPTIONSPANELS_TEXT_COLOUR.."Automatically Accept Quests"..FF_END_COLOUR;
FFOPTIONS_ACCEPT_QUESTS_TOOLTIP = "Automatically accepts quests from NPC's and group members.";
FFOPTIONS_ANNOUNCE_HEALTH_WARNING = FFOPTIONSPANELS_TEXT_COLOUR.."Send Low Health Warning to DualBox Master And/Or\nThe Person You Are Following"..FF_END_COLOUR;
FFOPTIONS_ANNOUNCE_HEALTH_WARNING_TOOLTIP = "Tells your DualBox Master and/or the person you are following when your health goes below 15%.\nRequires the DualBox Master or the person you are following to have "..FFMSG_ADDON_NAME.." v2.5 or higher installed.";
...
--DualBox Commands
    FFSLASH_SET_MASTER,
    FFSLASH_SET_MASTER_ALIAS,
    FFSLASH_CLEAR_MASTER,
    FFSLASH_CANCEL_RESUME_FOLLOW,
    FFSLASH_CANCEL_RESUME_FOLLOW_ALIAS
}
...
--DualBox Commands
    FFSLASH_SET_MASTER_HELPDIALOG,
    FFSLASH_CLEAR_MASTER_HELPDIALOG,
    FFSLASH_CANCEL_RESUME_FOLLOW_HELPDIALOG
}
