...
E.aura_db={
	["INTERRUPT"]={ -- XXX Do NOT merge Ids
...
--		[212619]={"softCC","interrupt",10,nil,6,136174}, -- Call Felhunter - interrupt uId -- removed
		...
		-- interrupt + silence
		-- Solar Beam will show 2 icons simultaneously for the interrupt and silence (no duration) effect. This is intentional.
		[97547]={"softCC","interrupt",7,nil,5,252188}, -- Solar Beam - interrupt uId (PvE and PvP) - castId is 78675 - silence debuffId=81261
		--[[ NOTE: We can ignore PvE only interrupts and track the Silence effect only as mobs don't dispel.
		...
		We're also ignoring PvP interrupts by Avenger's Shield w/ Shield of Virtue as it doesn't fire SPELL_INTERRUPT - castId=31935, Silence debuffId=217824]]--
	},
	["HARMFUL"]={
		-- Priority Debuffs
		...
		[205630]={"hardCC","stun",12,208618}, -- Illidan's Grasp (V) - (primary stun,aoe stun on 2ndary targets)
...
--		[205369]={"debuff","dispel",5}, -- Mind Bomb (trigger) (Magic) -- removed
		...
		[198819]={"debuff","reduceHealingReceived",1}, -- Mortal Strike (MS w/ Sharpen Blade debuff - 50% reduced healing recieved)
...
--		[118337]={"defensive","personalDefensive",6}, -- Harden Skin (Earth Elemental w/ Primal Elementalist) -- removed
		...
		--[207495]={"defensive","minorDefensive",6}, -- Ancestral Protection (buff on totem)
		-- Warlock
...
--		[200652]={"healing","healing",3}, -- Tyr's Deliverance (HoT effect shows on caster only)
		...
		[108281]={"healing","healing",6}, -- Ancestral Guidance (Class Talent Tree)
