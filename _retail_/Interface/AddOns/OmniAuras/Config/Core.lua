...
local fields = {
	...
	["Translations"] = format("%s (%s)", LFG_LIST_LANGUAGE_ITIT, "Grifo92"),
...
local isNotArenaFrameOverDebuffs = function(info)
	local filter = info[#info-2]
			...
			args = {
				...
				raidFrame = {
					...
					args = {
						...
						globalScale = {
							name = L["Global Scale"],
							desc = format("%s\n\n%s\n%s\n\n|cffff2020%s", L["Set the global scale of raid frame auras"], L["15: 10.1 default"], L["22: Legacy default"], L["Value is fixed at 15 when you are in a raid instance"]),
							order = 3,
							...
							args = {
								...
								layout = {
									...
									args = {
										...
										stackOuter = {
											disabled = function() return not E.profile.raidFrame.enabled or not E.profile.raidFrame.HARMFUL.enabled or E.profile.raidFrame.HARMFUL.preset ~= "overDebuffs" end,
					...
					args = {
						...
						anchor = {
							...
							args = {
								...
								frameLevel = {
									disabled = isNotArenaFrameOverDebuffs,
									name = L["Frame Level"],
									desc = L["-1: Show below Blizzard's buff/debuff icons (Tooltips will no longer work)"],
									order = 6,
									type = "range", min = -1, max = 9, step = 2,
