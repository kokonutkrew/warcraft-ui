    ...
    return {
        ...
        args = {
            ...
            Version = {
                ...
                guiHidden = true,
                func = function () HHTD:Print(L["VERSION"], '2.4.21,', L["RELEASE_DATE"], '2024-08-06T22:48:13Z') end,
                order = -5,
            },
            ShowGUI = {
                type = 'execute',
            ...
            core = {
                ...
                args = {
                    Info_Header = {
                        type = 'header',
                        name = L["VERSION"] .. ' 2.4.21 -- ' .. L["RELEASE_DATE"] .. ' 2024-08-06T22:48:13Z',
                        order = 1,
                    },
                    Pve = {
                        type = 'toggle',
