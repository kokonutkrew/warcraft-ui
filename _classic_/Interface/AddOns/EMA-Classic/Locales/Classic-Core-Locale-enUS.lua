...
--------------------------
-- Core Locale
L["STATUSTEXT"] = "EMA: Ebony's MultiBoxing Assistant Classic Edition"
...
L["COMBO_BAR_HEADER"] = "Combo Points Bar"
--------------------------
-- Follow Locale
...
L["QUEST_TRACKER_HEADER"] = "Quest Settings"
L["ENABLE_TRACKER"] = "Enable Quest Tracker"
L["ENABLE_TRACKER_HELP"] = "Enables The EMA Quest Tracker"
L["UNLOCK_TRACKER"] = "Disable Click-Through"
L["UNLOCK_TRACKER_HELP"] = "Disable Click-Through on the The Quest Tracker"
L["HIDE_BLIZZ_OBJ_TRACKER"] = "Hide Blizzard's Quest Tracker" 
L["HIDE_BLIZZ_OBJ_TRACKER_HELP"] = "Hides Default Blizzard Quest Tacker"
L["SHOW_JOT_ON_MASTER"] = "Show The EMA Quest Tracker On Master Toon"
L["SHOW_JOT_ON_MASTER_HELP"] = "Only show EMA Quest Tracker On Master Character Only"
L["HIDE_JOT_IN_COMBAT"] = "Hide EMA Quest Tracker In Combat"
L["HIDE_JOT_IN_COMBAT_HELP"] = "Hide EMA Quest Tracker in Combat"
L["SHOW_COMPLETED_OBJ_DONE"] = "Show Completed Objectives As 'DONE'"
L["SHOW_COMPLETED_OBJ_DONE_HELP"] = "Show Completed Quests As 'DONE'"
L["HIDE_OBJ_COMPLETED"] = "Hide Completed Quests"
L["HIDE_OBJ_COMPLETED_HELP"] = "Hide Quests Completed By The Team"
...
L["DONE"] = "Done"
L["TRACKER_TITLE_NAME"] = "EMA Quest Tracker"
L["REWARDS"] = "Rewards"
L["REWARDS_TEXT"] = "Completing This Quest Will \nReward You With:"
L["HEADER_MOUSE_OVER_QUESTWATCHER"] = "Hold Down \"ALT\" Key To Move EMA Quest Tracker"
L["UPDATE_MOUSE_OVER_QUESTWATCHER"] = "Force A Update Of The EMA Quest Tracker"
