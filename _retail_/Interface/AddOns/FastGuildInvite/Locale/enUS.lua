...
L["c-"] = "c-"
L["clearLeave"] = "/fgi clearLeave - Clear the list of players who left the guild."
...
L["Draenei"] = "Draenei"
L["dump"] = "/fgi dump - Opens a window to provide information about the addon."
L["Dwarf"] = "Dwarf"
...
L["hour, using a 12-hour clock"] = "hour, using a 12-hour clock"
L["hour, using a 24-hour clock"] = "hour, using a 24-hour clock"
...
L["Tauren"] = "Tauren"
L["the character"] = "the character"
L["the character name"] = "the character name"
L["time"] = "time"
...
L["Игнорировать игроков в рейдах, подземельях, аренах, полях боя. (только текущее дополнение)"] = "Ignore players in raids, dungeons, arenas, battlegrounds. (only the current addition)"
L["Игнорировать тихие зоны"] = "Ignore Quiet Zones"
...
L["Игроки отклонившие приглашение"] = "Players who declined the invitation"
L["Игроки отклонившие приглашение автоматически"] = "Players who declined the invitation automatically"
...
L["Классы:"] = "Classes:"
L["Количество запущенных поисков"] = "Number of Searches Started"
...
L["Найдено"] = "Found"
L["Найдено в результате поиска"] = "Found in search result"
...
L["Не отправлять приглашение"] = "Do not send invitation"
L["Не углублять поиск если вернулось 50 игроков"] = "Do not deepen the search if 50 players returned"
...
L["Окно поиска"] = "Scan frame"
L["Откл."] = "Turn off"
L["Отклонено"] = "Rejected"
L["Отклонено авт."] = "Auto rejected"
L["Отклонить"] = "Reject"
L["Отключить"] = "Disable"
L["Отправить запрос"] = "Send request"
L["Отправить сообщение и пригласить"] = "Send a message and invite"
L["Отправленные приглашения"] = "Sent invitations"
L["Отправлено"] = "Sended"
...
L["Поиск по локациям"] = "Search by location"
L["Поиск разблокирован"] = "Search Unlocked"
L["Поиски"] = "Search"
L["Показывать в чате текущий запрос"] = "Show current request in chat"
L["Показывать список обновлений"] = "Show list of updates"
L["Покинули"] = "Leave"
L["Покинули гильдию"] = "Left the guild"
...
L["Принято"] = "Accepted"
L["Принято приглашений"] = "Accepted invitations"
L["Причина"] = "Reason"
...
L["Статистика"] = "Statistics"
L["Статистика поиска"] = [=[Statistics.
