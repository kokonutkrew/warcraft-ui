isboxer.Character.Name = "Samoanranger";
isboxer.Character.ActualName = "Samoanranger";
isboxer.Character.QualifiedName = "Samoanranger-Emerald Dream";
...
function isboxer.Character_LoadBinds()
	if (isboxer.CharacterSet.Name=="#2") then
		...
		isboxer.SetMacro("InviteTeam","ALT-CTRL-SHIFT-I","/invite Samoanhunter\n/invite Tygrrlilly\n",nil,nil,nil,1);
...
isboxer.Output("Character 'Samoanranger' activated");
