  ...
  local FFSlashHighlighted = false;
    ...
    for SlashLine=1,8 do
        ...
        if SlashLinePlusOffset <= table.getn(FFSLASH_HELP_LIST_COMMANDS_TABLE) then
            _G["FFSlashEntry"..SlashLine.."ButtonTextName"]:SetText(FF_ColourText(FFSLASH_HELP_LIST_COMMANDS_TABLE[SlashLinePlusOffset], "blue"));
            ...
            _G["FFSlashEntry"..SlashLine]:Show();
        else
            _G["FFSlashEntry"..SlashLine]:Hide();
        end
  ...
  local FFWhisperHighlighted = false;
    ...
    for WhispLine=1,8 do
        ...
        if WhispLinePlusOffset <= table.getn(FFWHISP_COMMAND_LIST) then
            _G["FFWhispEntry"..WhispLine.."ButtonTextName"]:SetText(FF_ColourText(FFWHISP_COMMAND_LIST[WhispLinePlusOffset], "blue"));
            ...
            _G["FFWhispEntry"..WhispLine]:Show();
        else
            _G["FFWhispEntry"..WhispLine]:Hide();
        end
